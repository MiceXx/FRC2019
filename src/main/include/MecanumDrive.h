...
//this is our version, their are many like it but this one is ours. Without us this version is useless, without this version we are useless.
/**
...
class MecanumDrive : public RobotDriveBase {
 public:
   ...
   */
  MecanumDrive(frc::SpeedController& frontLeftMotor, frc::SpeedController& rearLeftMotor,
  ...
  void DriveTank(double ySpeedLeft, double xSpeedLeft, double ySpeedRight, double xSpeedRight);
