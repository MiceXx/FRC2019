...
void GripPipeline::Process(cv::Mat& source0){
	...
	double cvResizeFx = 0.24;  // default Double
	double cvResizeFy = 0.24;  // default Double
	...
	double hsvThresholdHue[] = {44.23318682937609, 180.0};
	double hsvThresholdSaturation[] = {0.0, 6.962457337883977};
